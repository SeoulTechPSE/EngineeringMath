...
subtitle: '<font color="red">Chapter 9. Vector Calculus</font>'
crossref: 
  eq-prefix: Eq.
format:
  revealjs: 
...
![](figures/ch09_figure01.png "Vector Functions"){fig-align="center"}
...
![](figures/ch09_figure02.png "Derivative"){fig-align="center"}
...
* To see this, note that $\mathbf{v}\cdot\mathbf{v}=c^2$. $~$ We differentiate both sides with respect to $t$ and obtain
  ...
  $${\scriptsize\frac{d}{dt}(\mathbf{v} \cdot \mathbf{v}) = \mathbf{v}\cdot\frac{d\mathbf{v}}{dt} +\frac{d\mathbf{v}}{dt} \cdot \mathbf{v}
...
![](figures/ch09_figure03.png "Unit Tangents"){fig-align="left"}
:::
...
😅
  ...
  * It follows from the differentiation of $\mathbf{T}\cdot\mathbf{T}=1\,$ that $\mathbf{T}\cdot \frac{d\mathbf{T}}{dt}=0$.
  $~$ If $\,\left\|\frac{d\mathbf{T}}{dt}\right\| \neq 0$, $~$ the vector
...
---
  ...
  * Since curvature is $~\kappa = \frac{\left\|\frac{d\mathbf{T}}{dt} \right\|}{v}$, $~$
...
![](figures/ch09_figure04.png "Acceleration"){width="80%" fig-align="center"}
:::
...
![](figures/ch09_figure05.png "Osculating plane"){width="80%" fig-align="center"}
:::
...
* Formulas for $a_T$, $a_N$, and Curvature
  ...
  \begin{align*}
     \mathbf{v}\cdot\mathbf{a} &= a_N(v\mathbf{T}\cdot\mathbf{N}) +a_T(v\mathbf{T}\cdot\mathbf{T})=a_T v\\ 
       & \Rightarrow \; a_T =\frac{dv}{dt} =\frac{\mathbf{v}\cdot\mathbf{a}}{\| \mathbf{v} \|}
         =\frac{\mathbf{r}'(t) \cdot \mathbf{r}''(t)}{\| \mathbf{r}'(t) \|}
  \end{align*}

  \begin{align*}
     \mathbf{v}\times\mathbf{a} &= a_N(v\mathbf{T}\times\mathbf{N}) +a_T(v\mathbf{T}\times\mathbf{T})
        =a_N v\mathbf{B}\\ 
     &\Rightarrow \; a_N =\kappa v^2 =\frac{\|\mathbf{v}\times\mathbf{a}\|}{\| \mathbf{v} \|}
...
![](figures/ch09_figure06.png "Radius curvature"){width="80%" fig-align="center"} 

### 9.4 $~$ Partial Derivatives

* Functions of Two Variables

![](figures/ch09_figure07.png "Functions of Two Variables"){width="80%" fig-align="center"} 
---
...
![](figures/ch09_figure09.png "Level Curves"){width="80%" fig-align="center"}   
---
...
![](figures/ch09_figure10.png "Arbitrary Direction"){width="80%" fig-align="center"} 
...
---
  ...
  ![](figures/ch09_figure11.png "Directional Derivative"){width="80%" fig-align="center"} 
...
. . .  
  ...
  * First, by the definition of a derivative,
  ...
  $${\scriptsize g'(0)=\lim_{h\to 0} \frac{g(0+h)-g(0)}{h}
  ...
  * Second, by the chain rule,
  ...
  $${\scriptsize\begin{align*}
      ...
      g'(0)& =f_x(x,y)\cos\theta+f_y(x,y)\sin\theta \\
           & =\left[\,f_x(x,y)\,\mathbf{i}+f_y(x,y)\,\mathbf{j} \,\right]\cdot 
...
* Geometric Interpretation of the Gradient
  ...
  $${\scriptsize\displaystyle \frac{\partial f}{\partial x}\frac{dx}{dt} +\frac{\partial f}{\partial y}\frac{dy}{dt}=0
...
$~$
  ...
  ${\scriptsize\quad\displaystyle \frac{\partial F}{\partial x}\frac{dx}{dt} +\frac{\partial F}{\partial y}\frac{dy}{dt}
...
![](figures/ch09_figure13.png "normal"){fig-align="left" width="30%"}
...
* Two important properties and plus alpha
  ...
  <font color="blue">
    $\mathrm{curl}(\mathrm{grad}\, f) = \nabla\times\nabla f = \mathbf{0}\\ 
     \;\;\;\;\;\;\;\;\;\;\;\;\;\; \Rightarrow \; \varepsilon_{ijk} \mathbf{e}_i \frac{\partial}{\partial x_j} \frac{\partial f}{\partial x_k} = 0 \mathbf{e}_i=\mathbf{0}$
  </font>
 
  <font color="blue">
     $\mathrm{div}(\mathrm{curl} \,\mathbf{f})=\nabla \cdot(\nabla\times\mathbf{f})=0 \\
     \;\;\;\;\;\;\;\;\;\;\;\;\;\; \Rightarrow \; \delta_{ij} \frac{\partial}{\partial x_i} \varepsilon_{jlm} \frac{\partial}{\partial x_l} f_m = \varepsilon_{ilm} \frac{\partial^2}{\partial x_i \partial x_l} f_m=0$
  </font>
...
=\mathbf{e}_m \frac{\partial^2 f_m}{\partial x_i^2}}$
  ...
  ${\scriptsize\nabla \times (\nabla \times \mathbf{f}) = \nabla (\nabla \cdot \mathbf{f}) -\nabla^2 \mathbf{f} =\; \varepsilon_{ijk} \mathbf{e}_i \frac{\partial}{\partial x_j} \varepsilon_{klm} \frac{\partial}{\partial x_l}f_m} \\
  \;\;\;\;\;\;\;\;\;\; {\scriptsize=(\delta_{il}\delta_{jm}-\delta_{im}\delta_{jl})\mathbf{e}_i \frac{\partial}{\partial x_j} \frac{\partial}{\partial x_l}f_m = \mathbf{e}_i \frac{\partial}{\partial x_i} \frac{\partial f_j}{\partial x_j} -\mathbf{e}_i \frac{\partial^2 f_i}{\partial x_j^2}}$
...
\begin{align*} 
 \scriptsize \nabla f \;&\scriptsize= \hat{\mathbf{q}}_1 \frac{1}{h_1} \frac{\partial f}{\partial q_1}
           + \hat{\mathbf{q}}_2 \frac{1}{h_2} \frac{\partial f}{\partial q_2}
           + \hat{\mathbf{q}}_3 \frac{1}{h_3} \frac{\partial f}{\partial q_3}\\ \\
 \scriptsize \nabla \cdot \mathbf{u} \;&\scriptsize= \frac{1}{h_1 h_2 h_3} \left[ \frac{\partial }{\partial q_1} \left( u_1h_2h_3 \right)
           + \frac{\partial }{\partial q_2} \left( u_2h_1h_3 \right)  
           + \frac{\partial }{\partial q_3} \left( u_3h_1h_2 \right)\right]\\ \\
 \scriptsize\nabla^2 f\;&\scriptsize= \frac{1}{h_1 h_2 h_3} \left[ \frac{\partial }{\partial q_1} \left( \frac{h_2 h_3}{h_1} \frac{\partial f}{\partial q_1} \right)
 ...
 \scriptsize\nabla \times \mathbf{u} \;&\scriptsize= \frac{1}{h_1 h_2 h_3} \begin{vmatrix}
...
$~$
<center>
<img src="figures/ch09_figure17.png" alt="various_curve" style="width:450px"/>
</center>
...
<center> 
<img src="figures/ch09_figure18.png" alt="sample_point_in_k" style="width:550px"/> 
</center>
...
::: {.column width="30%"}
<center> 
<img src="figures/ch09_figure19.png" alt="sample_point_in_k_subarc" style="width:300px"/>  </center> 
:::
...
::: {.column width="30%"} 
<center> 
<img src="figures/ch09_figure21.png" alt="circulation" style="width:380px"/> 
</center>
:::
...
* **Fundamental Theorem**
  ...
  ![](figures/ch09_figure22.png "regions"){width=30% fig-width=fig-align="center"}
...
* Then $\text{ }$ $\mathbf{f}=\nabla \phi~$ and $\nabla\times\mathbf{f}=\nabla\times\nabla\phi=\mathbf{0}\;$, $\,$ that is
  ...
  $${\scriptsize\frac{\partial P}{\partial y} =\frac{\partial Q}{\partial x}, \;\frac{\partial P}{\partial z} =\frac{\partial R}{\partial x},\;
...
* Properties of Double Integrals
  ...
  <img src="figures/ch09_figure24.png" alt="union_region" style="width:300px"/>
...
<img src="figures/ch09_figure26.png" alt="polar_rectangle" style="width:900px"/>  
...
:::{.column width="40%"}
  ...
  <img src="figures/ch09_figure28.png?raw=1" alt="R_2" style="width:250px"/> 
...
* If $\,P$, $Q$, $\frac{\partial P}{\partial y}$,
  ...
  <font color="red">$${\scriptsize\oint_C P \,dx +Q \,dy = \iint_R \left( \frac{\partial Q}{\partial x} -\frac{\partial P}{\partial y} \right)\, dA}$$</font>
...
<center>  <img src="figures/ch09_figure29.png" alt="direction_C" style="width:250px"/> </center>
...
* **Partial Proof**
  ...
  ![](figures/ch09_figure30.png "Vreen's Proof"){fig-align="center" width="30%"}
...
<center> <img src="figures/ch09_figure32.png" alt="Ex_region" style="width:400px"/> </center>
...
<center> <img src="figures/ch09_figure33.png" alt="surface_obove_R" style="width:600px"/></center>
...
::: {.column width="50%"}
  ...
  $${\scriptsize\begin{align*}
    ...
    & \Downarrow \\
    \Delta S_k &= {\scriptsize \sqrt{1 +\left[\,f_x(x_k,y_k)\right]^2 +\left[\,f_y(x_k,y_k)\right]^2}\Delta A_k }
  \end{align*}}$$
...
* If a smooth surface $S$ is $g(x,y,z)=0,\,$ a unit normal is
  ...
  <center> <img src="figures/ch09_figure35.png" alt="unit_normal" style="width:450px"/> </center>
...
::: {.column width="50%"}
  ...
  <center> <img src="figures/ch09_figure36.png" alt="flux" style="width:400px"/> </center>
...
* **Stokes' Theorem - Green's Theorem in 3-Space**
  ...
  * Let $~\mathbf{f}(x,y,z)=P(x,y,z)\mathbf{i} +Q(x,y,z)\mathbf{j} +R(x,y,z)\mathbf{k} \;\;\;$ be
  ...
  <font color="red">$$\oint_C \mathbf{f}\cdot \,d\mathbf{r} =\oint_C \mathbf{f}\cdot\mathbf{T}\,ds
   =\iint_R (\nabla \times\mathbf{f}) \cdot \mathbf{n}\,dS$$</font>

---

<center> <img src="figures/ch09_figure37.png" alt="Stokes" style="width:600px"/> </center>
...
* Physical Interpretation of Curl
 ...
 <center> <img src="figures/ch09_figure38.png" alt="physical_meaning_curl" style="width:400px"/> </center> 
...
* Let $F$ be a function of three variables defined over a closed region $D$ of space. Then the triple integral of $F$
  ...
  <img src="figures/ch09_figure39.png" alt="sub_region" style="width:300px"/>   
...
* Evaluation by Iterated Integrals
  ...
  <center> 
  <img src="figures/ch09_figure40.png" alt="triple_integral" style="width:400px"/> 
  </center>
...
* Triple Integrals in Cylindrical Coordinates
  ...
  $${\scriptsize 
   \begin{align*}
     ...
     &= \int_\alpha^\beta \int_{g_1(\theta)}^{g_2(\theta)} \int_{f_1(r,\theta)}^{f_2(r,\theta)} F(r,\theta,z)\,r\,dz\,dr\,d\theta
  \end{align*}}$$
  
  <center>
  <img src="figures/ch09_figure43.png" alt="cylindrical_wedge" style="width:800px"/>
  </center>
...
* Triple Integrals in Spherical Coordinates
  ...
  $${\scriptsize
    \begin{align*}
      ...
      &= \int_\alpha^\beta \int_{g_1(\theta)}^{g_2(\theta)} \int_{f_1(\phi,\theta)}^{f_2(\phi,\theta)} F(\rho,\theta,\phi)\,\rho^2 \sin\phi\, d\rho\,d\phi\,d\theta
    \end{align*}}$$

  <center>
  <img src="figures/ch09_figure45.png" alt="spherical_wedge" style="width:350px"/> 
  </center>
...
<center><img src="figures/ch09_figure46.png" alt="region_D" style="width:300px"/></center>
...
<center> 
<img src="figures/ch09_figure47.png" alt="region_D" style="width:150px"/> 
</center>
...
$$\begin{align*}
 \frac{dm}{dt} &= \frac{d}{dt}\iiint_D \rho(x,y,z,t)\,dV=\iiint_D \frac{\partial \rho}{\partial t}\,dV \\ 
 &= -\iint_S (\rho\mathbf{v}\cdot\mathbf{n})\,dS=-\iiint_D \nabla\cdot(\rho\mathbf{v})\,dV\\ 
 &\Downarrow \\ 
 \iiint_D \left[ \frac{\partial \rho}{\partial t} \right. &+\left. \phantom{\frac{}{}}\nabla\cdot(\rho\mathbf{v}) \right]\,dV=0 \\ 
 &\Downarrow \\
...
* Double Integrals
  ...
  $${\scriptsize \left| \frac{\partial(x,y)}{\partial(u,v)} \right| =
    \left|\begin{matrix}
...
* Triple Integrals
  ...
  $${\scriptsize \left| \frac{\partial (x,y,z)}{\partial (u,v,w)} \right| =
    \left|\begin{matrix}
